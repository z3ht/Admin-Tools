...
public class Gkick implements CommandExecutor{
	
	private Main plugin;
	public Gkick(Main plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (!(player.hasPermission("admin.gkick"))) {
		...
		Bukkit.broadcastMessage(ChatColor.DARK_RED + args[0] + ChatColor.RED + " has been kicked for: " + reason);
